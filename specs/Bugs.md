...
| BUG-S-021 | 2026-09-23 | Breakpoints (sidebar.scss:92, sidebar.xml:7) | **Gap 769-991px sin acceso a apps.** Sidebar visible solo ≥992px (`d-lg-flex`), toggle drawer solo ≤768px (`@media max-width:768`). **Resuelto:** unificación del breakpoint del toggle a 991px en sidebar.scss → toggle visible en todo el rango donde el sidebar está oculto (<992px). | UI/UX | 🟡 Media | Resuelto |
